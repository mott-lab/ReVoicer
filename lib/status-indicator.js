...
// processing (transcription / LLM work), green = ready. Errors still use
// toasts, which can carry a message and an action button.
//
...
//   const release = statusIndicator.begin('recording' | 'processing');
//   ... release();   // idempotent
// Recording wins over processing; ready when nothing is held.
...
(function () {
  ...
  const counts = { recording: 0, processing: 0 };
